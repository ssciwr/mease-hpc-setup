...
- the `expParameters` and `basedir` paths are modified
...
The file `slurm-12345.out` and the folder `/mnt/sds-hd/sd19b001/Liam/MUA_examples/example12021-08-20_M6_S1_ECE_Processing` are generated outputs from running the analysis.
...
- the files generated by the analysis (for this example) are found at `/mnt/sds-hd/sd19b001/Liam/MUA_examples/example12021-08-20_M6_S1_ECE_Processing`
